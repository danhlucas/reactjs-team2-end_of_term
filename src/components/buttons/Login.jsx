                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <form onSubmit={handleLogin}>
                                ...
                                </div>                                <div id="emailHelp" className="form-text">Please enter your Password</div>

                                <div className="mb-3 form-check">
                                    <input type="checkbox" checked={checkedRemember} onChange={e=> setCheckedRemember(e.target.checked)} className="form-check-input" id="exampleCheck1" />
                                    <label className="form-check-label" htmlFor="exampleCheck1">Remember me</label>
                                </div>
                                <button type="submit" className="btn btn-outline-dark w-100 mt-5" data-bs-toggle="modal" data-bs-target="#loginModal" >Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
